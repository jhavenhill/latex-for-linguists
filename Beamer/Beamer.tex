...
\frametitle{\texttt{qtree} package}
\begin{itemize}
\item <1-> The code looks like this:
\begin{verbatim}
\Tree [.DP [.D des ] [.$n$P
...
\end{verbatim}
\item <2-> It's fairly straightforward once you get the hang of it.
\begin{itemize}
    \item[$\rightarrow$] It's more or less typical syntactic bracketing
\end{itemize}
\item <2-> Try bracketing something yourself
\end{itemize}
\end{frame}

\subsection{ot-tableau}

\begin{frame}[fragile]
    \frametitle{\texttt{ot-tableau} package}
    \begin{center}
    \begin{tableau}{c:c|c}
    \inp{\ips{ri-aSO}} \const{*VV} \const{Dep} \const{Max}
    \cand{ri-aSO} \vio{*!} \vio{} \vio{}
    \cand[\Optimal]{r-aSO} \vio{} \vio{} \vio{*}
    \cand{ri-jaSO} \vio{} \vio{!*} \vio{}
    \end{tableau}
    \\
...
\begin{frame}[fragile]
    ...
    \begin{verbatim}
\begin{tableau}{c:c|c}
  \inp{\ips{ri-aSO}}     \const{*VV}    \const{Max} \const{Dep}
  \cand{ri-aSO}          \vio{*!}       \vio{}      \vio{}
  \cand[\Optimal]{r-aSO} \vio{}         \vio{}      \vio{*}
  \cand{ri-jaSO}         \vio{}         \vio{!*}    \vio{}
\end{tableau}
...
\frametitle{knitr}
	\begin{itemize}
		...
		\item <1-> knitr is a way to incorporate R code into your documents.
        ...
        \item <3-> knitr documents can be written directly in RStudio, or in something like Sublime Text with the \texttt{SublimeKnitr} plugin.
...
\includepdf{nwavPoster.pdf}
}

{
\setbeamercolor{background canvas}{bg=}
\includepdf{knitrbeamer.pdf}
}

\begin{frame}[fragile]
\frametitle{knitr}
\begin{center}
\includegraphics[width=0.7\textwidth]{knitr.png}
\end{center}
\end{frame}
